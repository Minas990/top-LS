...
Serverless-flavored GitHub language stats card. Send a GitHub username, get back an SVG showing their language breakdown (top bar + legend), styled after GitHub's own contribution language chart.
...
![Example card output](example.png)
...
arch-diagram.png               Static export of the Lucidchart diagram
